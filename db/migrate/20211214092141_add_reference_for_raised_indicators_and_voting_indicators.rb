...
class AddReferenceForRaisedIndicatorsAndVotingIndicators < ActiveRecord::Migration[6.1]
  def up
    ...
    execute "ALTER TABLE ONLY raised_indicators ALTER COLUMN integer_id DROP DEFAULT;"
    change_column_null :raised_indicators, :integer_id, true
    execute "DROP SEQUENCE IF EXISTS raised_indicators_id_seq"
